        ...
        <div class="dostupneKnjige" >
            ...
            <table class="licniPodaciTabela" style="background-color: #D8D8D8; width: 30%">
                ...
                <tr >
                    ...
                    <td><input type="text" placeholder="Stara lozinka" v-model="staraLozinka" style="width: 90%; "></td>
                </tr>
                <br/>
                <tr>
                    <td><b><i>Nova lozinka:</i></b> </td>
                    <td><input type="text" placeholder="Nova lozinka" v-model="novaLozinka" style="width: 90%; "> </td>
                </tr>
                <br/>
                <tr>
                    <td><b><i>&nbsp; Nova lozinka (ponovo): &nbsp;</i></b> </td>
                    <td><input type="text" placeholder="Nova lozinka" v-model="novaLozinkaPonovo" style="width: 90%; "></td>
                </tr>
                <br/>
